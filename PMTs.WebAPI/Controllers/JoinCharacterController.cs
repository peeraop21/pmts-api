...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class JoinCharacterController(PMTsDbContext context) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "JoinCharacter.GetAll");
                data = JsonConvert.SerializeObject(_unitOfWork.JoinCharacter.GetAll());
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "JoinCharacter.GetAll Success");
