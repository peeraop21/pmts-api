...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class HierarchyLV3Controller(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                ...
                data = JsonConvert.SerializeObject(_unitOfWork.HierarchyLV3s.GetAll());
        ...
        [HttpPost]
        public IActionResult Post(string FactoryCode, [FromBody] HierarchyLv3 model)
        {
            string AppCaller = User.GetClaimValue("AppName");
            string exceptionMessage;
            var data = string.Empty;
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "HierarchyLV3s.Add");
                _unitOfWork.HierarchyLV3s.Add(model);
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "HierarchyLV3s.Add Success");
                return Ok(new CustomResponse<string> { Message = Global.ResponseMessages.Success, StatusCode = StatusCodes.Status200OK, Result = data });
            }
            catch (Exception ex)
            {
        ...
        [HttpPut]
        public IActionResult Put(string FactoryCode, [FromBody] HierarchyLv3 model)
        {
            string AppCaller = User.GetClaimValue("AppName");
            string exceptionMessage;
            var data = string.Empty;
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "HierarchyLV3s.Update");
                _unitOfWork.HierarchyLV3s.Update(model);
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "HierarchyLV3s.Update Success");
                return Ok(new CustomResponse<string> { Message = Global.ResponseMessages.Success, StatusCode = StatusCodes.Status200OK, Result = data });
            }
            catch (Exception ex)
            {
