...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class MasterRoleController(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Post(string FactoryCode, [FromBody] ParentModel model)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "MasterRoles.Add");
                _unitOfWork.MasterRoles.Add(model.MasterRole);
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "MasterRoles.Add Success");
                return Ok(new CustomResponse<string> { Message = Global.ResponseMessages.Success, StatusCode = StatusCodes.Status200OK, Result = data });
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Put(string FactoryCode, [FromBody] ParentModel model)
        {
            ...
            try
            {
                ...
                _unitOfWork.MasterRoles.Update(model.MasterRole);
