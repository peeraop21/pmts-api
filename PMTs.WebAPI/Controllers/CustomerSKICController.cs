...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class CustomerSKICController(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "CustomerSKIC.GetAll");
                data = JsonConvert.SerializeObject(_unitOfWork.CustomerSKIC.GetCustomerSKICAll());
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "CustomerSKIC.GetAll Success");
        ...
        [HttpGet]
        [Route("GetCustomerSKICByCustId")]
        public IActionResult GetCustomerSKICByCustId(string FactoryCode, string CusID)
        {
            string AppCaller = User.GetClaimValue("AppName");
            string exceptionMessage;
            var data = string.Empty;
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "CustShipTos.GetCustShipToListByCustCode, Params : " + CusID);
                data = JsonConvert.SerializeObject(_unitOfWork.CustomerSKIC.GetCustomerSKICByCustId(CusID));
