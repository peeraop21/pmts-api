...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class QaItemsController(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "QaItems.QaItems, Params : " + FactoryCode.ToString());
                data = JsonConvert.SerializeObject(_unitOfWork.QaItems.GetAllByFactory(null));
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "QaItems.GetAll Success");
