...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class JointController(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.GetAll");
                data = JsonConvert.SerializeObject(_unitOfWork.Joints.GetAll());
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.GetAll Success");
        ...
        public IActionResult Post(string FactoryCode, [FromBody] ParentModel model)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.Add");
                _unitOfWork.Joints.Add(model.Joint);
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.Add Success");
                return Ok(new CustomResponse<string> { Message = Global.ResponseMessages.Success, StatusCode = StatusCodes.Status200OK, Result = data });
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Put(string FactoryCode, [FromBody] ParentModel model)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.Update");
                _unitOfWork.Joints.Update(model.Joint);
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "Joints.Update Success");
                return Ok(new CustomResponse<string> { Message = Global.ResponseMessages.Success, StatusCode = StatusCodes.Status200OK, Result = data });
            }
            catch (Exception ex)
            {
