...
namespace PMTs.WebAPI.Controllers
{
    ...
    [ApiController]
    public class SbRoutingController(PMTsDbContext pmtsContext) : Controller
    {
        ...
        public IActionResult Get(string FactoryCode)
        {
            ...
            try
            {
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "SbRoutings.GetAllByFactory, Params : " + FactoryCode.ToString());
                data = JsonConvert.SerializeObject(_unitOfWork.SbRoutings.GetAllByFactory(r => r.FactoryCode == FactoryCode));
                Logger.Info(AppCaller, FactoryCode, this.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, "SbRoutings.GetAllByFactory Success");
